const UP = `
CREATE OR REPLACE FUNCTION public.content_lists_plainto_tsquery(source text)
RETURNS tsquery
LANGUAGE sql
IMMUTABLE
AS $function$
...
const DOWN = `
DROP FUNCTION public.content_lists_plainto_tsquery(source text);
`;
